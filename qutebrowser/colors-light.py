...
# completion
c.colors.completion.even.bg = offwhite
c.colors.completion.odd.bg = c.colors.completion.even.bg
c.colors.completion.fg = darkgrey
c.colors.completion.category.fg = blue
c.colors.completion.category.bg = offwhite
...
# statusbar
## normal mode
c.colors.statusbar.normal.fg = darkgrey
c.colors.statusbar.normal.bg = offwhite
c.colors.statusbar.command.fg = darkgrey
c.colors.statusbar.command.bg = offwhite
